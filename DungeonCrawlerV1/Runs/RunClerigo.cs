...
{
    public class RunClerigo
    {
        //Start do Clerigo
        public static void PegarMonstroClerigo()
        {
                ...
                switch (op)
                {
                    case EscolhaRun.Masmorra:
                        ...
                        if (sorteioMonstro == 1)
                        {
                            ...
                            while (clerigo.VidaMaxima > 0 && beholder.VidaMaxima > 0)
                            {
                                Console.WriteLine("++ Turno do Player ++");
                                Console.WriteLine($"Player HP: {clerigo.VidaMaxima}");
                                ...
                                if (beholder.VidaMaxima > 0)
                                {
                                    ...
                                    if (Nsorteio == 1)
                                    {
                                        ...
                                        clerigo.VidaMaxima -= beholder.Ataque;
                                        Console.ForegroundColor = ConsoleColor.Red;
                                        Console.WriteLine("..............................................");
                        ...
                        else if (sorteioMonstro == 2)
                        {
                            ...
                            while (clerigo.VidaMaxima > 0 && panteraDeslocadora.VidaMaxima > 0)
                            {
                                Console.WriteLine("++ Turno do Player ++");
                                Console.WriteLine($"Player HP: {clerigo.VidaMaxima}");
                                Console.WriteLine($"Player XP: {jogador.XP}");
                                ...
                                if (panteraDeslocadora.VidaMaxima > 0)
                                {
                                    ...
                                    if (Nsorteio == 1)
                                    {
                                        ...
                                        clerigo.VidaMaxima -= panteraDeslocadora.Ataque;
                                        Console.ForegroundColor = ConsoleColor.Red;
                                        Console.WriteLine("..............................................");
                        ...
                        else if (sorteioMonstro == 3)
                        {
                            ...
                            while (clerigo.VidaMaxima > 0 && monstrodaFerrugem.VidaMaxima > 0)
                            {
                                Console.WriteLine("++ Turno do Player ++");
                                Console.WriteLine($"Player HP: {clerigo.VidaMaxima}");
                                Console.WriteLine($"Player XP: {jogador.XP}");
                                ...
                                if (monstrodaFerrugem.VidaMaxima > 0)
                                {
                                    ...
                                    if (Nsorteio == 1)
                                    {
                                        ...
                                        clerigo.VidaMaxima -= monstrodaFerrugem.Ataque;
                                        Console.ForegroundColor = ConsoleColor.Red;
                                        Console.WriteLine("..............................................");
                        ...
                        else if (sorteioMonstro == 4)
                        {
                            ...
                            while (clerigo.VidaMaxima > 0 && cuboGelatinoso.VidaMaxima > 0)
                            {
                                Console.WriteLine("++ Turno do Player ++");
                                Console.WriteLine($"Player HP: {clerigo.VidaMaxima}");
                                Console.WriteLine($"Player XP: {jogador.XP}");
                                ...
                                if (cuboGelatinoso.VidaMaxima > 0)
                                {
                                    ...
                                    if (Nsorteio == 1)
                                    {
                                        ...
                                        clerigo.VidaMaxima -= cuboGelatinoso.Ataque;
                                        Console.ForegroundColor = ConsoleColor.Red;
                                        Console.WriteLine("..............................................");
                        ...
                        else if (sorteioMonstro == 5)
                        {
                            ...
                            while (clerigo.VidaMaxima > 0 && lich.VidaMaxima > 0)
                            {
                                Console.WriteLine("++ Turno do Player ++");
                                Console.WriteLine($"Player HP: {clerigo.VidaMaxima}");
                                Console.WriteLine($"Player XP: {jogador.XP}");
                                ...
                                if (lich.VidaMaxima > 0)
                                {
                                    ...
                                    if (Nsorteio == 1)
                                    {
                                        lich.Ataque = random.Next(3, 5);
                                        clerigo.VidaMaxima -= lich.Ataque;
                                        Console.ForegroundColor = ConsoleColor.Red;
                                        Console.WriteLine("..............................................");
                        ...
                        else
                        {
                            ...
                            while (clerigo.VidaMaxima > 0 && devoradordeMentes.VidaMaxima > 0)
                            {
                                Console.WriteLine("++ Turno do Player ++");
                                Console.WriteLine($"Player HP: {clerigo.VidaMaxima}");
                                Console.WriteLine($"Player XP: {jogador.XP}");
                                ...
                                if (devoradordeMentes.VidaMaxima > 0)
                                {
                                    ...
                                    if (Nsorteio == 1)
                                    {
                                        ...
                                        clerigo.VidaMaxima -= devoradordeMentes.Ataque;
                                        Console.ForegroundColor = ConsoleColor.Red;
                                        Console.WriteLine("..............................................");
