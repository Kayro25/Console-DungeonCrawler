...
{
    public class RunDruida
    {
        //Start do Druida
        public static void PegarMonstroDruida()
        {
                ...
                switch (op)
                {
                    case EscolhaRun.Masmorra:
                        ...
                        if (sorteioMonstro == 1)
                        {
                            ...
                            while (druida.VidaMaxima > 0 && beholder.VidaMaxima > 0)
                            {
                                Console.WriteLine("++ Turno do Player ++");
                                Console.WriteLine($"Player HP: {druida.VidaMaxima}");
                                ...
                                if (beholder.VidaMaxima > 0)
                                {
                                    ...
                                    if (Nsorteio == 1)
                                    {
                                        ...
                                        druida.VidaMaxima -= beholder.Ataque;
                                        Console.ForegroundColor = ConsoleColor.Red;
                                        Console.WriteLine("..............................................");
                        ...
                        else if (sorteioMonstro == 2)
                        {
                            ...
                            while (druida.VidaMaxima > 0 && panteraDeslocadora.VidaMaxima > 0)
                            {
                                Console.WriteLine("++ Turno do Player ++");
                                Console.WriteLine($"Player HP: {druida.VidaMaxima}");
                                Console.WriteLine($"Player XP: {jogador.XP}");
                                ...
                                if (panteraDeslocadora.VidaMaxima > 0)
                                {
                                    ...
                                    if (Nsorteio == 1)
                                    {
                                        ...
                                        druida.VidaMaxima -= panteraDeslocadora.Ataque;
                                        Console.ForegroundColor = ConsoleColor.Red;
                                        Console.WriteLine("..............................................");
                        ...
                        else if (sorteioMonstro == 3)
                        {
                            ...
                            while (druida.VidaMaxima > 0 && monstrodaFerrugem.VidaMaxima > 0)
                            {
                                Console.WriteLine("++ Turno do Player ++");
                                Console.WriteLine($"Player HP: {druida.VidaMaxima}");
                                Console.WriteLine($"Player XP: {jogador.XP}");
                                ...
                                if (monstrodaFerrugem.VidaMaxima > 0)
                                {
                                    ...
                                    if (Nsorteio == 1)
                                    {
                                        ...
                                        druida.VidaMaxima -= monstrodaFerrugem.Ataque;
                                        Console.ForegroundColor = ConsoleColor.Red;
                                        Console.WriteLine("..............................................");
                        ...
                        else if (sorteioMonstro == 4)
                        {
                            ...
                            while (druida.VidaMaxima > 0 && cuboGelatinoso.VidaMaxima > 0)
                            {
                                Console.WriteLine("++ Turno do Player ++");
                                Console.WriteLine($"Player HP: {druida.VidaMaxima}");
                                Console.WriteLine($"Player XP: {jogador.XP}");
                                ...
                                if (cuboGelatinoso.VidaMaxima > 0)
                                {
                                    ...
                                    if (Nsorteio == 1)
                                    {
                                        ...
                                        druida.VidaMaxima -= cuboGelatinoso.Ataque;
                                        Console.ForegroundColor = ConsoleColor.Red;
                                        Console.WriteLine("..............................................");
                        ...
                        else if (sorteioMonstro == 5)
                        {
                            ...
                            while (druida.VidaMaxima > 0 && lich.VidaMaxima > 0)
                            {
                                Console.WriteLine("++ Turno do Player ++");
                                Console.WriteLine($"Player HP: {druida.VidaMaxima}");
                                Console.WriteLine($"Player XP: {jogador.XP}");
                        ...
                        else
                        {
                            ...
                            while (druida.VidaMaxima > 0 && devoradordeMentes.VidaMaxima > 0)
                            {
                                Console.WriteLine("++ Turno do Player ++");
                                Console.WriteLine($"Player HP: {druida.VidaMaxima}");
                                Console.WriteLine($"Player XP: {jogador.XP}");
                                ...
                                if (devoradordeMentes.VidaMaxima > 0)
                                {
                                    ...
                                    if (Nsorteio == 1)
                                    {
                                        ...
                                        druida.VidaMaxima -= devoradordeMentes.Ataque;
                                        Console.ForegroundColor = ConsoleColor.Red;
                                        Console.WriteLine("..............................................");
